...
public class Transaction {
    ...
    public Transaction(User recipient, User sender, TransferCategory transferCategory, float transferAmount,
            UUID identifier) {
        this.identifier = (identifier != null) ? identifier : UUID.randomUUID();
    ...
    public Transaction(User recipient, User sender, TransferCategory transferCategory, float transferAmount) {
        this(recipient, sender, transferCategory, transferAmount, null);
    }
    ...
    public String toString() {
        return "To " + sender.getName() + "(id = " + sender.getIdentifier() + ") " +
